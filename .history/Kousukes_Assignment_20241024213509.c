...
int init(int* a, int n) {
    ...
    // Insert the initial prefix sum of 0 at index -1
 ...
 *
 * Calls the solution function to execute the main logic of the program.
 *
 * @return 0 if the program executed successfully, 1 otherwise.
 */
/******  0b3ceacd-5fc9-4776-94e7-3a798b062cd3  *******/int main() {
    solution();
    return 0;
}
